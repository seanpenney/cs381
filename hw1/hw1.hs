...
data Gates = Gate Int Gatefn Gates | Empty

data Gatefn = And | Or | Xor | Not
				deriving Show

data Links = Link Int Int Int Int links | Empty

--b)
Circuit (Gate 1 Xor (Gate 2 And Empty)) (Link 1 1 2 1 (Link 1 2 2 2 Empty))
...
ppGates Empty = ""
ppGates (n fn g) = show n ++ ":" ++ show fn ++ ";\n" ++ pp g

ppLinks :: Links -> String
ppLinks Empty == ""
ppLinks (a b c d l) = "from " ++ show a ++ "." ++ show b ++ " to " ++ show c ++ "." show d ++ ppLinks l
